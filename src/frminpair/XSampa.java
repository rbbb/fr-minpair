...
public class XSampa {
	...
	public static class Consonant implements Phoneme
	{
		...
		public String toString() {
			return "Consonant [noModification=" + noModification + ", voiced="
					+ voiced + ", place=" + place + ", type=" + type
					+ ", xSampaCode=" + xSampaCode + ", ipaCode=" + ipaCode
	...
	public static class Vowel implements Phoneme
	{
		...
		@Override
		public String toString() {
			return "Vowel [noModification=" + noModification + ", nasalized="
					+ nasalized + ", roundedness=" + roundedness
					+ ", openness=" + openness + ", position=" + position
					+ ", xSampaCode=" + xSampaCode + ", ipaCode=" + ipaCode
					+ ", name=" + name + ", example=" + example
					+ ", longVowel=" + longVowel + "]";
		}
